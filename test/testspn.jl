...
@testset "Defining and evaluating discrete SPNs" begin
    ...
    @testset "Evaluation" begin
        ...
        @testset "Evaluating Simple DAG SPN at $a,$b" for a=1:2, b=1:2
            v = SPN([a,b])
    ...
    @testset "Sampling" begin
        ...
        @testset "Verifing Count estimates for Siple DAG SPN at $a,$b" for a in 1:2, b in 1:2
            ref = SPN([a,b])
